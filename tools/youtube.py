...
# --- HELPER FUNCTIONS (Taaki purane imports ki zaroorat na pade) ---
def time_to_seconds(time):
    stringt = str(time)
    return sum(int(x) * 60**i for i, x in enumerate(reversed(stringt.split(":"))))

# --- COOKIES LOGIC ---
# Pehle root check karega, nahi mila toh assets folder
...
class YouTubeAPI:
    ...
    async def download(
        ...
        # 🔥 HAR DOWNLOADER FUNCTION ME SOURCE_ADDRESS ADD KIYA HAI
        ...
        if songvideo:
            ...
            # Removed 'is_on_off' dependency, default to robust downloader
            direct = True
